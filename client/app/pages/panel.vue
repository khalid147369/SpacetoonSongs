...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-purple-500 to-purple-600 px-4 py-8"
  >
    <section class="mx-auto max-w-2xl rounded-lg bg-white p-8 shadow-2xl">
      ...
      <form @submit.prevent="handleSubmit" autocomplete="off">
        ...
        <!-- Preview Area -->
        <div
          class="mb-6 min-h-32 rounded border-2 border-dashed border-gray-300 bg-gray-50 p-4"
          role="region"
          aria-live="polite"
        >
        ...
        <div
          ...
          :class="{
            ...
            'bg-red-100 text-red-800': messageType !== 'success',
          }"
